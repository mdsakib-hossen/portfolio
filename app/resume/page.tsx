    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .banner { background: linear-gradient(135deg, #1e1b4b 0%, #4c1d95 50%, #831843 100%); padding: 36px 48px; display: flex; justify-content: space-between; align-items: center; gap: 20px; flex-wrap: wrap; }
        .banner-left .name { font-size: 32px; font-weight: 800; color: #fff; letter-spacing: -0.5px; }
        .banner-left .title { font-size: 13px; color: #c4b5fd; margin-top: 6px; font-weight: 500; }
        .banner-right { text-align: right; font-size: 12px; color: #e2d9f3; line-height: 2; }
        .banner-right a { color: #c4b5fd; text-decoration: none; }
        .body { display: grid; grid-template-columns: 1fr 2fr; }
        .left-col { background: #faf5ff; padding: 32px 24px; border-right: 1px solid #e9d5ff; }
        .right-col { padding: 32px 36px; }
        ...
        .about-text { font-size: 12.5px; color: #475569; line-height: 1.8; }
        .edu-item { margin-bottom: 12px; }
        .edu-inst { font-size: 13px; font-weight: 700; color: #1e1b4b; }
        .edu-dept { font-size: 11.5px; color: #64748b; margin-top: 2px; }
        .edu-year { font-size: 11px; color: #a78bfa; font-weight: 600; margin-top: 3px; }
        .skill-group { margin-bottom: 12px; }
        .skill-label { font-size: 10.5px; font-weight: 700; color: #1e1b4b; margin-bottom: 5px; text-transform: uppercase; letter-spacing: 0.5px; }
        ...
        .cp-platform { font-size: 11.5px; font-weight: 700; color: #4c1d95; }
        .cp-handle { font-size: 10.5px; color: #94a3b8; font-family: monospace; }
        ...
        .ach-title { font-size: 11.5px; font-weight: 700; color: #1e1b4b; }
        .ach-org { font-size: 10.5px; color: #94a3b8; margin-top: 1px; }
        .project-item { margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid #f1f5f9; }
        ...
        .project-name { font-size: 13px; font-weight: 700; color: #1e1b4b; }
        .project-badge { font-size: 9.5px; font-weight: 700; padding: 2px 8px; border-radius: 20px; white-space: nowrap; flex-shrink: 0; }
        ...
        .project-desc { font-size: 11.5px; color: #64748b; line-height: 1.7; margin-bottom: 6px; }
        ...
        .footer { background: linear-gradient(135deg, #1e1b4b, #4c1d95); padding: 14px 48px; text-align: center; font-size: 11px; color: #c4b5fd; font-style: italic; }
        @media print { .print-btn { display: none !important; } body { background: white; } .page { margin: 0; border-radius: 0; box-shadow: none; max-width: 100%; } }
      `}</style>
